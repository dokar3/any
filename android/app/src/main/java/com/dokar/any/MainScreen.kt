...
import any.ui.common.modifier.horizontalWindowInsetsSpacers
...
fun MainScreen(
    ...
    AnimatedAppNavGraph(
        ...
        modifier = modifier.horizontalWindowInsetsSpacers(
            insets = WindowInsets.navigationBars,
            spacerBackgroundColor = if (darkMode) Color.Unspecified else Color.Black,
        ),
