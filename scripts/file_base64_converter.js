...
node file_base64_converter.js ${OPT_FILE_TO_BASE64_TXT} input_file output.txt

Convert base 64 string to file:
node file_base64_converter.js ${OPT_BASE64_STRING_TO_FILE} BASE_64_STRING output_file

Converter base 64 encoded text file to file:
node file_base64_converter.js ${OPT_BASE64_TXT_FILE_TO_FILE} base64.txt output_file
`
